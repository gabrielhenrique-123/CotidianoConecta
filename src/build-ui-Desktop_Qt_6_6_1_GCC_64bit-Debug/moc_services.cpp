...
static constexpr auto qt_meta_stringdata_CLASSServicesENDCLASS = QtMocHelpers::stringData(
    "Services"
);
...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_CLASSServicesENDCLASS_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_CLASSServicesENDCLASS_t qt_meta_stringdata_CLASSServicesENDCLASS = {
    {
        QT_MOC_LITERAL(0, 8)   // "Services"
    },
    "Services"
};
